...
public class MpNewsMessage extends Message {
    ...
    public static class Article {
        ...
        /**
         * 是	图文消息的标题，不超过128个字节，超过会自动截断
         */
        private String title;

        /**
         * 是	图文消息缩略图的media_id, 可以在上传多媒体文件接口中获得。此处thumb_media_id即上传接口返回的media_id
         */
        ...
        /**
         * 否	图文消息点击“阅读原文”之后的页面链接
         */
        private String content_source_url;

        /**
         * 是	图文消息的内容，支持html标签，不超过666 K个字节
         */
        private String content;

        /**
         * 否	图文消息的描述，不超过512个字节，超过会自动截断
         */
