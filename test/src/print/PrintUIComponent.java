...
public class PrintUIComponent extends JPanel implements ActionListener,
    ...
    public PrintUIComponent() {
        ...
        textAreaToPrint.append("                         江南大学2018年\n                    艺术类专业考试合格证\n");
        textAreaToPrint.append("准考证号：324534345\n");
        textAreaToPrint.append("姓名：孙彬焱\n");
        textAreaToPrint.append("性别：男\n");
        textAreaToPrint.append("生源地：四川\n");
        textAreaToPrint.append("身份证号：324534345\n");
        textAreaToPrint.append("考生号：0001\n");
        textAreaToPrint.append("报考专业：软件工程\n");
        textAreaToPrint.append("专业成绩：324\n");
        textAreaToPrint.append("专业名次：100\n");
        textAreaToPrint.append("专业合格线：300\n");
        /*for (int i = 1; i <= 50; i++) {
        ...
        JButton printButton = new JButton("PrintHelp This TextArea");
        printButton.setName("printButton");
        printButton.addActionListener(this);
        JButton printPreviewButton = new JButton("PrintHelp Preview");
    ...
    private void initPrinterJob() {
        ...
        job.setJobName("PrintHelp Certificate");// 出现在系统打印任务列表
    ...
    private void createAndShowPreviewDialog() {
        JDialog previewDialog = new JDialog(frame, "PrintHelp Preview Dialog", true);
